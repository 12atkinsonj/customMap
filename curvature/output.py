...
class OutputTools(object):
    ...
    def get_collection_description(self, collection):
        ...
        description = description + f"Ratio: {collection['ratio']:.2f}\nMin Speed: {collection['minspeed']}\nMax Speed: {collection['maxspeed']}\nAvg Speed: {collection['avgspeed']}\n"
...
class SingleColorKmlOutput(KmlOutput):
    ...
    def get_styles(self):
        ...
        styles = {'unpaved0':{'color':'F000E010'}} # Straight roads
        styles = {'unknown0':{'color':'7F00E010'}} # Straight roads
        ...
        for i in range(256):
            ...
            styles['unpaved{}'.format(i + 1)] = {'color':'F000{:02X}FF'.format(255 - i)}
            styles['unknown{}'.format(i + 1)] = {'color':'F000{:02X}FF'.format(255 - i)}
        ...
        for i in range(1, 256):
            ...
            styles['unpaved{}'.format(i + 256)] = {'color':'F0{:02X}00FF'.format(i)}
            styles['unknown{}'.format(i + 256)] = {'color':'F0{:02X}00FF'.format(i)}
